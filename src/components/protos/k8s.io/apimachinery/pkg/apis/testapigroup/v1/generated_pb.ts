...
export const file_k8s_io_apimachinery_pkg_apis_testapigroup_v1_generated: GenFile = /*@__PURE__*/
  fileDesc("", [file_k8s_io_apimachinery_pkg_apis_meta_v1_generated, file_k8s_io_apimachinery_pkg_runtime_generated, file_k8s_io_apimachinery_pkg_runtime_schema_generated]);
...
/**
 * @generated from message k8s.io.apimachinery.pkg.apis.testapigroup.v1.CarpInfo
 */
export type CarpInfo = Message<"k8s.io.apimachinery.pkg.apis.testapigroup.v1.CarpInfo"> & {
  /**
   * A is the first map key.
   * +required
   *
   * @generated from field: optional int64 a = 1;
   */
  a: bigint;
   ...
   * +optional
   *
   * @generated from field: optional string c = 4;
   */
  c: string;
...
/**
 * Describes the message k8s.io.apimachinery.pkg.apis.testapigroup.v1.CarpInfo.
 * Use `create(CarpInfoSchema)` to create a new message.
 */
export const CarpInfoSchema: GenMessage<CarpInfo> = /*@__PURE__*/
...
export type CarpSpec = Message<"k8s.io.apimachinery.pkg.apis.testapigroup.v1.CarpSpec"> & {
   ...
   * +optional
   *
   * @generated from field: optional string deprecatedServiceAccount = 9;
   */
...
export type CarpStatus = Message<"k8s.io.apimachinery.pkg.apis.testapigroup.v1.CarpStatus"> & {
   ...
   * +listMapKey=c
   *
   * @generated from field: repeated k8s.io.apimachinery.pkg.apis.testapigroup.v1.CarpInfo infos = 8;
   */
  infos: CarpInfo[];
};
...
export const CarpStatusSchema: GenMessage<CarpStatus> = /*@__PURE__*/
  messageDesc(file_k8s_io_apimachinery_pkg_apis_testapigroup_v1_generated, 5);
